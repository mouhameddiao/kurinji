...
function ProductDetailAccessoires() {
  const { id } = useParams();
  ...
  return (
    <div className="product-detail bg-white py-16 px-8">
      <div className="container mx-auto flex flex-col md:flex-row items-center">
        ...
        <div className="md:w-1/2 mt-8 md:mt-0">
          ...
          <p className="text-xl font-semibold text-gray-600 mb-4">{product.description}</p>
          ...
          {product.options && (
            <div className="mb-4">
              <label className="block text-lg font-semibold text-gray-700 mb-2">Taille:</label>
          ...
          {/* Shoe size selection if applicable */}
          <div className="mb-4">
...
export default ProductDetailAccessoires;
